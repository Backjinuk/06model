...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="receiverName" 	class="ct_input_g"  
						style="width: 100px; height: 19px" maxLength="20" value="${purchaseVO.buyer }" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input		type="text" name="receiverRequest" 	class="ct_input_g"  value="${purchaseVO.divyRequest }"
							style="width: 100px; height: 19px" maxLength="20" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<input 	type="date"  name="receiverDate" class="ct_input_g" value="${purchaseVO.divyDate }"
							style="width: 100px; height: 19px" maxLength="20"/>
