...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">{purchaseVO.byer.userId }</td>
		<input type="hidden" name="buyerId" value="${purchaseVO.buyer.userId }"/>
		<input type="hidden" name="product" value="${purchaseVO.purchaseProd.prodNo}"/>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" ${! empty purchaseVO.paymentOption == "1" ? "selectec" : "" }>현금구매</option>
				<option value="2" ${! empty purchaseVO.paymentOption == "2" ? "selectec" : "" }>신용구매</option>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			style="width: 100px; height: 19px" 	maxLength="20" value="${purchaseVO.buyer.userName }" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td width="200" class="ct_write01">
			<input 	type="date"  name="divyDate" class="ct_input_g" value="${purchaseVO.divyDate }"
