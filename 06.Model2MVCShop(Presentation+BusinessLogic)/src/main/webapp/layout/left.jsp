	...
	//==> jQuery 적용 추가된 부분
		 $(function() {
			...
			$(".Depth03:contains('구매이력조회')").on("click", function() {					
 			...
 			$(".Depth03:contains('장바구니 바로가기')").on("click", function() {
				//self.location="/cart/getCartList";
				$(window.parent.frames["rightFrame"].document.location).attr("href","/cart/getCartList");
			});
		...
		<tr>
			<td valign="top">
				<table border="0" cellspacing="0" cellpadding="0" width="159">
					...
					<tr>
						<td class="Depth03"><a href="javascript:history()">최근 본상품</a></td>
					</tr>
				</table>
			</td>
		</tr>
