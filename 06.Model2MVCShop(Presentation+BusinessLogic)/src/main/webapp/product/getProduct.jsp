			...
			<tr>
				...
				<c:if test="${user.userId eq 'admin'}">
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="/product/updateProductView?prodNo=${productVO.prodNo }" >수정</a>
					</td>
				</c:if>
				<c:if test="${user.userId ne 'admin' }">
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="/cart/addCartView?prodNo=${productVO.prodNo }">장바구니</a>
					</td>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="/purchase/addPurchaseView?prodNo=${productVO.prodNo }">구매</a>
					</td>
				</c:if>				 
				<td width="14" height="23">
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
					<a href="/listProduct.do?menu=manage" >목록으로</a>
				</td>
				<td width="14" height="23">
					<img src="/images/ct_btnbg03.gif" width="14" height="23">
				</td>
